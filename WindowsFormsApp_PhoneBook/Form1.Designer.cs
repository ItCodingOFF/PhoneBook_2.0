...
namespace WindowsFormsApp_PhoneBook
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonNEW.Size = new System.Drawing.Size(50, 23);
			...
			this.buttonEDIT.Location = new System.Drawing.Point(86, 3);
			...
			this.buttonDELETE.Location = new System.Drawing.Point(216, 3);
			...
			this.textBoxINFORMATION.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.phoneBookBindingSource, "info", true));
			...
			this.textBoxCATEGORY.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.phoneBookBindingSource, "category", true));
			...
			this.textBoxADDRESS.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.phoneBookBindingSource, "address", true));
			...
			this.textBoxPHONE.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.phoneBookBindingSource, "phone", true));
			...
			this.textBoxNAME.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.phoneBookBindingSource, "fullname", true));
